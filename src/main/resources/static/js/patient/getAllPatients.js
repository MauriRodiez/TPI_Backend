...
//                                      '</button>';
            ...
            patientRow.innerHTML =
                    ...
                    '<td class=\"td_apellido\">' + patient.surname.toUpperCase() + '</td>' +
                    '<td class=\"td_dni\">' + patient.dni + '</td>' +
                    '<td class=\"td_fecha\">' + patient.registrationDate + '</td>' +
                    '<td class=\"td_calle\">' + patient.street.toUpperCase() + '</td>' +
                    '<td class=\"td_numero\">' + patient.street + '</td>' +
                    '<td class=\"td_estado\">' + patient.state.toUpperCase() + '</td>';
