...
function updateFindBy(id) {
  ...
  fetch(url, settings)
    ...
    .then((data) => {
      ...
      document.querySelector("#street_up").value = patient.addressDTO.street;
      document.querySelector("#street_num_up").value = patient.addressDTO.number;
      document.querySelector("#state_up").value = patient.addressDTO.state;
